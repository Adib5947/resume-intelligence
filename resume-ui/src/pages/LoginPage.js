...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden text-white">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative z-10 bg-[#1a1f35] border border-white/20 rounded-2xl p-10 w-[400px] text-center shadow-2xl">
            ...
            <p className="text-gray-400 text-sm mb-6">
              ...
              Please log in with your email and password for now.
            </p>
            <button
              onClick={() => setShowSocialModal(false)}
      ...
      {/* Card */}
      <div className="relative z-10 backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-12 w-[480px] shadow-2xl">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full bg-transparent border-b border-gray-400 focus:outline-none focus:border-pink-400 py-3 text-lg placeholder-gray-400 transition"
          />
        </div>
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full bg-gradient-to-r from-purple-500 to-pink-500 py-3.5 rounded-xl font-semibold text-lg hover:scale-105 transition disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100"
        >
          {loading ? (
